...
public class TransparentTextureMaterialActivity extends EngineActivity {

	@Override
	public Engine createEngine(GLView glView) {
		TransparentTextureMaterialGame game = new TransparentTextureMaterialGame(glView, this);
	...
	public int getContentViewId() {
		return R.layout.activity_game_material_transparent;
	}
